# Lea Trueworthy
# November 2, 2024
# CSD 325 - Module 3.2 Assignment: Brownfield + Flowchart(s)
# Description: Make the following changes to the chohan.py program:
...
while True:  # Main game loop.
    ...
    while True:
        pot = input('lt: ')  # Changed prompt to your initials
        if pot.upper() == 'QUIT':
    ...
    while True:
        bet = input('lt: ').upper()  # Changed prompt to your initials
    ...
    if total == 2 or total == 7:
        print(f'You rolled a total of {total} and get a 10 mon bonus!')
